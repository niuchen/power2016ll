...
public class UploadUtils {
	...
	public static final DateFormat DAY_FORMAT = new SimpleDateFormat("/yyyyMMdd/HHmmss");
	public static final DateFormat MONTH_FORMAT_ = new SimpleDateFormat("yyyyMM");
	
	public static String generateFilename(String path, String ext) {
		return path + MONTH_FORMAT.format(new Date())+ RandomStringUtils.random(4,IdGen.randomBase62(36)) + "." + ext;
	}
	/**
	 * 获取年月目录，前后带路径
	 * @return
	...
	public static String getMonthPath(){
		return File.separator+MONTH_FORMAT_.format(new Date())+File.separator;
	}
