...
var gr_InstallPath = "/res/grf/grinstall"; //实际项目中应该写从根目录寻址的目录，如gr_InstallPath="/myapp/report/grinstall"; 
var gr_Version = "6,1,17,0208";
...
function CreatePrintViewerEx2(PluginID, Width, Height, ReportURL, DataURL, AutoRun, ExParams)
{
	...
	document.write('<param name="UserName" value="' + gr_UserName + '">');//opaque opaque
	document.write('<param value="high" name="quality"><param name="wmode" value="opaque">');
